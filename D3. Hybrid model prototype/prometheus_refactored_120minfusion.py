# -*- coding: utf-8 -*-
"""Prometheus_Refactored_120minFusion.ipynb

Automatically generated by Colab.

Original file is located at
    https://colab.research.google.com/drive/1AtUPQPCh3vVa3rcfC0rzbpuIGIo1Euri
"""
...
physics=pd.read_csv('complete_predictions_120min.csv')

tcn=pd.read_csv('tcn_12step_pred_unscaled.csv')
...
test['kd_future'] = test['kd_value'].shift(-12)

test['true_regime'] = test.apply(
    lambda r: get_regime(r['kd_future'], r['solar_elevation_deg'])
    if pd.notna(r['kd_future']) else np.nan,
    axis=1)

test['persisted_regime'] = test['true_regime']
...
for idx, row in test.iterrows():
    ...
    if regime == 0:
        ...
        X = pd.DataFrame(
            [[row['prediction'], row['prediction_w']]],
...
print("RMSE using persisted regime (future kd, current elevation):", rmse_persist_regime)
